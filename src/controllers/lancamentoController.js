...
module.exports = {
    ...
    async listarTodos(req, res){
        try {
            const animais = await LancamentoModel.findAll()
    ...
    async obterPorId(req, res){
        try {
            const animal = await LancamentoModel.findAll({where: {id: req.params.id}});
    ...
    async criar(req, res){
        try {
            const animal = await LancamentoModel.create(req.body);
            return res.json(animal);
        } catch (err) {
    ...
    async atualizar(req, res){
        ...
        try {
            await LancamentoModel.update(req.body, {where: {id: {[operacao.eq]: id }}});
    ...
    async remover(req, res){
        try {
            await LancamentoModel.destroy({where: {id: req.params.id }});
